...
RSpec.describe Slot do
  ...
  context "num_used" do
    ...
    it "accurately counts the number of slots used" do
      ...
      AirlineRoute.new(airline: other_airline, origin_airport: fun, destination_airport: maj, economy_price: 1, premium_economy_price: 2, business_price: 3).save(validate: false)
