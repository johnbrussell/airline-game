...
RSpec.describe AirplaneRoute do
  ...
  context "recalculate_profits_and_block_time" do
    it "updates the block time, flight cost, and route revenue" do
      ...
      inu_market.update(name: "Nauru", income: 100000, country: "Nauru", country_group: "Nauru")
      inu_population = Population.create!(year: 2000, population: 100000, market_id: inu_market.id)
      inu_tourists = Tourists.create!(year: 2000, volume: 1000, market_id: inu_market.id)
      fun_market = Fabricate(:market, name: "Funafuti", income: 100000, country: "Tuvalu", country_group: "Tuvalu")
      fun_population = Population.create!(year: 2000, population: 100000, market_id: fun_market.id)
      ...
      family = Fabricate(:aircraft_family)
      distance = Calculation::Distance.between_airports(airport_1, airport_2)
      model = Fabricate(:aircraft_model, floor_space: Airplane::ECONOMY_SEAT_SIZE, takeoff_distance: 9997, max_range: distance + 1, speed: 1500)
      airplane = Fabricate(:airplane, aircraft_family: family, aircraft_model: model, economy_seats: 1, operator_id: Airline.last.id, base_country_group: Airline.last.base.country_group)
