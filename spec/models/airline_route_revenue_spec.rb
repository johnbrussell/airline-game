...
RSpec.describe AirlineRouteRevenue do
  context "valid?" do
    ...
    it "is true when revenue is calculated correctly and the seats are calculated correctly" do
      subject = AirlineRouteRevenue.new(revenue: 174 * 2, exclusive_economy_revenue: 1, exclusive_premium_economy_revenue: 1, exclusive_business_revenue: 1, economy_pax: 138, premium_economy_pax: 12, business_pax: 4, airline_route: airline_route)

      expect(subject.valid?).to be true
    end

    it "is false when revenue is not calculated correctly" do
      subject = AirlineRouteRevenue.new(revenue: 174 * 2, exclusive_economy_revenue: 1, exclusive_premium_economy_revenue: 1, exclusive_business_revenue: 1, economy_pax: 138.1, premium_economy_pax: 11.9, business_pax: 4, airline_route: airline_route)
    ...
    it "is false when seats are not sufficient for economy passengers" do
      subject = AirlineRouteRevenue.new(revenue: 174, exclusive_economy_revenue: 1, exclusive_premium_economy_revenue: 1, exclusive_business_revenue: 1, economy_pax: 138.1, premium_economy_pax: 11.9, business_pax: 4, airline_route: airline_route)
    ...
    it "is false when seats are not sufficient for premium economy passengers" do
      subject = AirlineRouteRevenue.new(revenue: 174, exclusive_economy_revenue: 1, exclusive_premium_economy_revenue: 1, exclusive_business_revenue: 1, economy_pax: 138, premium_economy_pax: 12.1, business_pax: 4, airline_route: airline_route)
    ...
    it "is false when seats are not sufficient for business passengers" do
      subject = AirlineRouteRevenue.new(revenue: 174, exclusive_economy_revenue: 1, exclusive_premium_economy_revenue: 1, exclusive_business_revenue: 1, economy_pax: 138, premium_economy_pax: 12, business_pax: 4.1, airline_route: airline_route)
  ...
  context "zero_out" do
    ...
    it "sets revenue and passengers to zero" do
      ...
      expect(subject.exclusive_economy_revenue).to eq 0
      expect(subject.exclusive_premium_economy_revenue).to eq 0
      expect(subject.exclusive_business_revenue).to eq 0
