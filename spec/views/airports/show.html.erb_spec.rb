...
RSpec.describe "airports/show", type: :feature do
  ...
  it "shows information about airline routes at the airport" do
    ...
    AirlineRouteRevenue.new(airline_route_id: fun_inu.id, revenue: 100, exclusive_revenue: 1, business_pax: 1, economy_pax: 2, premium_economy_pax: 1).save(validate: false)
    ...
    AirlineRouteRevenue.new(airline_route_id: bos_inu.id, revenue: 100, exclusive_revenue: 2, business_pax: 1, economy_pax: 2, premium_economy_pax: 1).save(validate: false)
