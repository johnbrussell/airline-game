...
RSpec.describe "used_airplanes/airplanes/index", type: :feature do
  context "index" do
    it "shows the number of used aircraft available" do
      ...
      used_airplane_1 = instance_double(Airplane, aircraft_model: model_1, construction_date: "2015-01-01".to_date, economy_seats: 10, premium_economy_seats: 9, business_seats: 8)
      used_airplane_2 = instance_double(Airplane, aircraft_model: model_2, construction_date: "2010-01-01".to_date, economy_seats: 100, premium_economy_seats: 90, business_seats: 80)
