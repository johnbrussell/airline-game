...
RSpec.describe "routes/index", type: :feature do
  ...
  it "has a link to each route the airline flies" do
    ...
    AirlineRouteRevenue.new(airline_route_id: route_1.id, revenue: 100, exclusive_revenue: 1, business_pax: 1, economy_pax: 2, premium_economy_pax: 1).save(validate: false)
    ...
    AirlineRouteRevenue.new(airline_route_id: route_2.id, revenue: 100, exclusive_revenue: 100, business_pax: 1, economy_pax: 2, premium_economy_pax: 1).save(validate: false)
