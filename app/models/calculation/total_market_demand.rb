  ...
  private
    ...
    def self.destination_business_demands(origin_airport, destination_market, date)
      destination_market.airports.map { |airport|
        {
          airport: airport,
          demand: Calculation::ResidentDemand.new(origin_airport, airport, date).business_demand(date),
        }
      }
    end
    ...
    def self.destination_government_demands(origin_airport, destination_market, date)
      destination_market.airports.map { |airport|
        {
          airport: airport,
          demand: Calculation::GovernmentDemand.new(origin_airport, airport, date).demand(date),
        }
      }
    end
    ...
    def self.destination_leisure_demands(origin_airport, destination_market, date)
      destination_market.airports.map { |airport|
        {
          airport: airport,
          demand: Calculation::ResidentDemand.new(origin_airport, airport, date).leisure_demand(date),
        }
      }
    end
    ...
    def self.destination_tourist_demands(origin_airport, destination_market, date)
      destination_market.airports.map { |airport|
        {
          airport: airport,
          demand: Calculation::TouristDemand.new(origin_airport, airport, date).demand(date),
        }
      }
    end
