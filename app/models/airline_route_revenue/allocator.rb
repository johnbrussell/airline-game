class AirlineRouteRevenue::Allocator
  def self.allocate(solicitations, class_revenue)
    earned_revenue, unallocated_solicitations = allocate_and_subtract_solicitations(solicitations, class_revenue)
    earned_revenue
  end

  def self.allocate_and_subtract_solicitations(solicitations, class_revenue)
  ...
  def self.subtract_exclusive_allocations(solicitations, exclusive_revenue)
    earned_revenue, unallocated_solicitations = allocate_and_subtract_solicitations(solicitations, exclusive_revenue)
