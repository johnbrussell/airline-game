...
class Calculation::ResidentDemandTest < ActiveSupport::TestCase
  ...
  test "demand is zero when origin and destination market are the same" do
    ...
    actual_business = Calculation::ResidentDemand.new(micronesia.airports.first, micronesia.airports.last, Date.today).business_demand(Date.today)
    actual_leisure = Calculation::ResidentDemand.new(micronesia.airports.first, micronesia.airports.last, Date.today).leisure_demand(Date.today)
    expected = 0
  ...
  test "demand is zero when the origin and destination markets are rivals" do
    ...
    actual_business = Calculation::ResidentDemand.new(micronesia.airports.first, kosrae.airports.last, Date.today).business_demand(Date.today)
    actual_leisure = Calculation::ResidentDemand.new(micronesia.airports.first, kosrae.airports.last, Date.today).leisure_demand(Date.today)
    expected = 0
  ...
  test "business demand is equivalent to the island demand curve when between islands, domestic, and the demand-maximizing distance" do
    ...
    actual = Calculation::ResidentDemand.new(pohnpei.airports.first, kosrae.airports.first, Date.today).business_demand(Date.today)
  ...
  test "leisure demand is equivalent to the island demand curve when between islands, domestic, and the demand-maximizing distance" do
    ...
    actual = Calculation::ResidentDemand.new(pohnpei.airports.first, micronesia.airports.last, Date.today).leisure_demand(Date.today)
  ...
  test "demand is halved when the origin is not an island" do
    ...
    actual_business = Calculation::ResidentDemand.new(pohnpei.airports.first, kosrae.airports.first, Date.today).business_demand(Date.today)
    expected_business = kosrae.populations.first.population / 2.0

    actual_leisure = Calculation::ResidentDemand.new(pohnpei.airports.first, micronesia.airports.last, Date.today).leisure_demand(Date.today)
